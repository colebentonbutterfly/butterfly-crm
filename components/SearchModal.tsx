    ...
    <div className="fixed inset-0 z-50 flex items-start justify-center pt-[15vh]" onClick={onClose}>
      ...
      >
        <div className="flex items-center gap-3 px-4 py-3 border-b border-gray-200">
          ...
          />
          <kbd className="hidden sm:inline-block text-xs text-gray-400 bg-gray-100 px-1.5 py-0.5 rounded">ESC</kbd>
        </div>
        {query.trim() && (
              ...
              results.map((item, i) => (
                ...
                >
                  <div>
                    ...
                    <p className="text-xs text-gray-500">{item.category} &middot; {item.barcode}</p>
                  </div>
