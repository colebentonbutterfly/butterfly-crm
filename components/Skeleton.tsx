    ...
    <div className="space-y-6 animate-pulse">
      ...
      <div className="flex flex-col md:flex-row gap-6">
        <div className="md:w-1/3 space-y-4">
          <div className="w-full aspect-square bg-gray-200 dark:bg-gray-700 rounded-xl" />
          <div className="card"><div className="h-16 bg-gray-200 dark:bg-gray-700 rounded" /></div>
        </div>
        <div className="flex-1 space-y-4">
          <div className="card space-y-3">
            ...
            <div className="grid grid-cols-2 gap-4 mt-4">
              {Array.from({ length: 4 }).map((_, i) => (
                <div key={i}><div className="h-3 bg-gray-200 dark:bg-gray-700 rounded w-16 mb-1" /><div className="h-4 bg-gray-200 dark:bg-gray-700 rounded w-24" /></div>
              ))}
            </div>
          </div>
        </div>
