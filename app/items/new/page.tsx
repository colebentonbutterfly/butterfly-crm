...
function NewItemContent() {
  ...
  return (
    <ItemForm item={barcode ? { name: "", description: "", category: "Miscellaneous", location: "Pod 1", condition: "Good", quantity: 1, barcode, photoUrl: "", photoUrls: [], notes: "", boxNumber: "" } : undefined} />
  );
}
